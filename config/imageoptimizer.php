...
//
        'pngquant_bin'     => '/usr/local/Cellar/pngquant/2.6.0/bin/pngquant',
...
//
        'gifsicle_bin'     => '/usr/local/Cellar/gifsicle/1.88/bin/gifsicle',
        'gifsicle_options' => ['-b', '-O5'],

        'jpegoptim_bin'     => '/usr/local/Cellar/jpegoptim/1.4.3/bin/jpegoptim',
